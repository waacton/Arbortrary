...
public class GeneratedImage
{
    ...
    {
        var brush = new SolidBrush(colour.ToRgba32());
    ...
    public void AddLine(PointF point1, Unicolour colour1, PointF point2, Unicolour colour2)
    {
        ...
        var brush = new LinearGradientBrush(point1, point2, GradientRepetitionMode.DontFill, colorStop1, colorStop2);
        Png.Mutate(x => x.DrawLine(brush, thickness, point1, point2));
        AddGifFrame();
    }
